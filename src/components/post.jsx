...
function Post({ name, avatar, nickname, content, image, date}) {
    return (
        <div className="post">
            ...
            <div className="post__container">
                <div className="post__header">
                    <div className="post__header-wrapper">
                        <span className="author-name">
                            {name}
                            <svg className="oficial-icon" viewBox="0 0 24 24">
                                <g>
                    ...
                    <div className="post__button">
                        <svg viewBox="0 0 96 96" className="post-button-icon">
                            <title />
                ...
                <div className="post__body">
                    ...
                    <img className="post__img" src={image} alt="post-img" />
                </div>
